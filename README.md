<p align="center">
  <img src="public/banner.svg" alt="HIA Banner" width="100%">
</p>
...
4. Set up Supabase database schema:
   Use the SQL script provided at [`supabase_schema.sql`](https://github.com/ridhupriyaa12/Health-Agent/blob/main/supabase_schema.sql).
